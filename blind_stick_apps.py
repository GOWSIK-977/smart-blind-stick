...
class SmartBlindStick:
    ...
    def get_enhanced_laptop_location(self):
        ...
        # Method 1: WiFi Positioning (most accurate)
        ...
        # Method 2: Enhanced IP Geolocation
        ...
        # Method 3: Manual Perundurai Location
    ...
    def generate_frames(self):
        ...
        while True:
            ...
            cv2.putText(frame, f"Mobile Connected: {len(self.clients)}", (10, 80), 
            ...
            cv2.putText(frame, f"{source_icon} Source: {loc_source}", (10, 105), 
                       cv2.FONT_HERSHEY_SIMPLEX, 0.4, (255,255,0), 1)
            
            loc_text = f"Location: {self.current_location.get('address', 'Unknown')[:35]}"
            cv2.putText(frame, loc_text, (10, 125), cv2.FONT_HERSHEY_SIMPLEX, 0.4, (255,255,255), 1)
            
            coord_text = f"Coords: {self.current_location.get('lat', 0):.6f}, {self.current_location.get('lng', 0):.6f}"
            cv2.putText(frame, coord_text, (10, 145), cv2.FONT_HERSHEY_SIMPLEX, 0.4, (255,255,255), 1)
            
            if self.emergency_mode:
                cv2.putText(frame, "EMERGENCY MODE ACTIVE", (10, 170), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 0, 255), 2)
    ...
    def run(self):
        ...
        self.speak("Smart Blind Stick system started with Google Maps", "system")
        
        print("\n" + "="*60)
        print("🦯 SMART BLIND STICK SYSTEM WITH GOOGLE MAPS")
        print("="*60)
        ...
        print("\n🎯 LOCATION METHODS:")
        print("   1. 📡 WiFi Positioning (most accurate)")
        print("   2. 🌐 IP Geolocation (city-level)")
        print("   3. 📍 Manual Perundurai Location (fallback)")
...
<body>
    <div class="container">
        <div class="header">
            <h1>🦯 Smart Blind Stick <span style="font-size: 12px;">Google Maps Location</span></h1>
        ...
        <div class="card">
            ...
            <div id="alertList" class="alert-list"><div class="alert-item"><div class="alert-time">System</div><div class="alert-title">✅ Ready</div><div class="alert-message">Google Maps with laptop location active</div></div></div>
        </div>
    ...
    <script>
        ...
        function connectWebSocket() {{
            ...
            ws.onopen = () => {{
                ...
                addAlert('System', 'Connected to laptop with Google Maps');
            }};
        ...
        console.log('✅ Mobile assistant ready - Google Maps with laptop location');
    </script>
</body>
</html>
'''
...
if __name__ == "__main__":
    ...
    print("\n🎯 LAPTOP LOCATION METHODS:")
    print("   1. 📡 WiFi Positioning (most accurate)")
    print("   2. 🌐 IP Geolocation (city-level)")
    print("   3. 📍 Manual Perundurai Location (fallback)")
    print("\n📊 API ENDPOINTS:")
    print(f"   • Stats: http://{local_ip}:5000/database/stats")
    print(f"   • Detections: http://{local_ip}:5000/database/detections")
    print(f"   • Alerts: http://{local_ip}:5000/database/alerts")
    print(f"   • Analytics: http://{local_ip}:5000/database/analytics")
    print("\n🚨 HOW TO USE:")
    print("   1. Open the URL above on your MOBILE PHONE")
    print("   2. Google Maps will show laptop location")
    print("   3. Click 'Open in Google Maps' for full navigation")
    print("   4. Change map view (Road/Satellite/Hybrid/Terrain)")
    print("   5. Press 'E' key or click button for emergency")
    print("="*60 + "\n")
